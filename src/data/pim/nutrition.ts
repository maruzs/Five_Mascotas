...
export const defaultFoodNutrition: Record<string, FoodNutritionProfile> = {
  ...
  'prod-1': {
    ...
    firstFiveIngredients: [
      ...
      'Maíz molido',
      'Salvado de trigo',
      'Grasa vacuna estabilizada',
      'Vitaminas y minerales balanceados'
    ],
    primaryProteinSource: 'Carne vacuna y cereales nobles',
    hasProbiotics: false,
    omega3_6: true,
    qualityRating: 3,
    caloricDensityKcalKg: 3350,
    recommendationNote: 'Excelente rendimiento económico por kilogramo para perros adultos con nivel de actividad moderado.'
  },
  'prod-2': {
    productId: 'prod-2',
    brand: 'Dogxtreme',
